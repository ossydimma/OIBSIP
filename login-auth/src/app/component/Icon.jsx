...
export const Icon = ({ setPasswordType, classType }) => {
  ...
  const handleIcon = () => {
    if (showIcon) {
      ...
      classType === "icon"
        ? setPasswordType((prev) => ({ ...prev, pass: "text" }))
        : setPasswordType((prev) => ({ ...prev, confirmPass: "text" }));
    } else {
      setShowIcon(true);
      classType === "icon"
        ? setPasswordType((prev) => ({ ...prev, pass: "password" }))
        : setPasswordType((prev) => ({ ...prev, confirmPass: "password" }));
    }
  };
  return (
